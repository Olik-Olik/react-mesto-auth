...
{/*НОС защита от неавторизованных*/}
                      <ProtectedRoute
                          path ="/"
                      loggedIn = {loggedIn}
                      {/*   типа тогда показываем компонент  {Main} и остальной функционал*/}
                      >
                      </ProtectedRoute>
{/*авторизация*/}
                        <Route exact path="/sign-up ">
                            ...
                            InfoTooltip={handleInfoTooltip}//успешная регистрация
                            />
                        </Route>
 ...
 {/*регистрация */}
                        ...
                        < Route exact path="/">
                            {this.state.loggedIn ? <Redirect to="/sign-up"/> : <Redirect to="/login"/>}
                        </Route>
                    </Switch>
                </main>
                </>
